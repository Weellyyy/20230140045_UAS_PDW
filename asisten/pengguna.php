...
$result = $conn->query("SELECT id, nama, email, role, created_at FROM users ORDER BY role, nama ASC");
?>
...
<div class="mb-6">
    <a href="pengguna_form.php" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg inline-flex items-center">
            ...
            <tbody class="text-gray-700">
                <?php if ($result->num_rows > 0): ?>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-4">
                            <span class="capitalize px-2 py-1 text-xs font-semibold rounded-full <?php echo $row['role'] == 'asisten' ? 'bg-blue-200 text-blue-800' : 'bg-green-200 text-green-800'; ?>">
                        ...
                        <td class="py-3 px-4 text-center">
                            <!-- Tombol Edit -->
                            <a href="pengguna_form.php?edit_id=<?php echo $row['id']; ?>" class="text-blue-500 hover:text-blue-700 mr-4">
                            ...
                            <!-- Tombol Hapus: nonaktifkan jika itu akun admin sendiri -->
                            <?php if ($row['id'] != $_SESSION['user_id']): ?>
                            <form action="pengguna.php" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengguna ini?');" class="inline-block">
